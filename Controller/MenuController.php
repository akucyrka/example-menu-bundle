...
use akucyrka\ExampleMenuBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('akucyrkaExampleMenuBundle:Menu')->findAll();
     ...
     * @Method("POST")
     * @Template("akucyrkaExampleMenuBundle:Menu:new.html.twig")
     */
    ...
    public function showAction($slug)
    {
        ...
        $entity = $em->getRepository('akucyrkaExampleMenuBundle:Menu')->findBySlug($slug);
        $entity = $entity[0];
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('akucyrkaExampleMenuBundle:Menu')->find($id);
     ...
     * @Method("PUT")
     * @Template("akucyrkaExampleMenuBundle:Menu:edit.html.twig")
     */
